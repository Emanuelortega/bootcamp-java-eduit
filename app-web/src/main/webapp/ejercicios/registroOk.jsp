	    	...
	    	<div class="row">
	    		<div class="col-6">
			        ...
			        <section>
			        	...
			        	<h3>Articulos=<%Collection<Articulo> list =(Collection<Articulo>)request.getAttribute(AttributesEnum.ARTICULOS.getValue());%></h3>
			        		<table class="table">
							  <thead>
							    <tr>
							      <th scope="col">ID</th>
							  ...
							  <!-- repetir cantidad de elementos que tenga la lista-->
